    ...
    <StyledBrief>
      ...
      <StyledInfoWrapp>
        ...
        <StyledDescr>
          ...
          почати роботу над унікальним рішенням, яке відповідає вашим
          очікуванням. Не гайте час - натискайте "Заповнити зараз" та допоможіть
          нам розпочати роботу над вашим проєктом вже сьогодні!
        </StyledDescr>
      </StyledInfoWrapp>
