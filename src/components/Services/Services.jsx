...
const servicesData = [
  {
    ...
    title: "Розробка ПЗ",
    description:
      "Наша досвідчена команда може розробити програмне забезпечення для широкого кола галузей промисловості та застосувань, зокрема сільського господарства, фінансів, охорони здоров’я та логістики.",
